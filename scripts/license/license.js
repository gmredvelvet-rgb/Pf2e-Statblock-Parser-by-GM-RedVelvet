/**
 * PF2e Statblock Parser — licence client.
 *
...
/**
 * Localize an `pf2e-statblock-parser.License.*` key, interpolating `data` when given.
 * @param {string} key
 * @param {object} [data]
 * @returns {string}
 */
export const L = (key, data) => localize(`pf2e-statblock-parser.License.${key}`, data);
