/**
 * PF2e Statblock Parser - enganche del soft gate.
 *
  ...
  try {
    ...
    if ( !game.modules.get(HUB_ID)?.active ) {
      game.settings.registerMenu(MODULE_ID, "licenseMenu", {
        name:  "pf2e-statblock-parser.Settings.License.Name",
        label: "pf2e-statblock-parser.Settings.License.Label",
        hint:  "pf2e-statblock-parser.Settings.License.Hint",
